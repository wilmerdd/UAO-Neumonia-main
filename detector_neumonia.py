...
class App():
    ...
    def load_img_file(self):
        filepath = filedialog.askopenfilename(initialdir="/", title="Select image", filetypes=(('DICOM', '*.dcm'), ('JPEG', '*.jpeg;*.jpg'), ('PNG', '*.png')))
        if filepath:
            ...
            if img2show is not None:
                ...
                print(f"No se pudo cargar la imagen desde {filepath}")
